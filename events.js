        ...
        choices: [
            {
                ...
                outcome: { e: 5, unlock: ['main-2'] }
            }, {
                name: "No, have it studied",
                test: ["DC 18 Investigation","???"],
                success: { text: "???", unlock: ['main-3'] },
                failure: { text: "???", unlock: ['main-3'] }
            }
        ]
    },
]
...
let opportunityDeck = [
    {
        type: 'opportunity',
        name: "The Omenmaster",
        text: "Whilst travelling, you encountered an old ruin. Living in the ruin was an even older witch called the Omenmaster, who claimed she could see 'beyond the shroud of time and space.' She offered to grant her wisdom in exchange for a generous donation.",
        choices: [
            {
        ...
        choices: [
            {
                ...
                outcome: { text: "Gain the benefits of a long rest." }
            }, {
        ...
        choices: [
            {
                ...
                test: ["DC 11 Persuasion"],
                success: { i: 1 },
                failure: null
            }, {
                name: "Challenge her to a contest",
                test: ["DC 16 Performance"],
                success: { i: 3 },
                failure: null
            }
        ]
    },
    {
        ...
        text: "Earl Rodiri Flashheart, a noble from one of the neighbouring states, has paid us a visit with the hopes of fostering a good relationship. They are charming and delightful, and may be willing to loan us some troops. They're also fabulously wealthy, and it's possible we may be able to engineer a trade agreement that substantially favours us.",
        choices: [
            {
...
let dilemmaDeck = [
    {
        type: 'dilemma',
        name: 'Returned Exile',
        text: "Thirty years ago, a once-great warrior named Galia Stoneheart was banished from our lands for murder. She has recently returned, despite her exile.",
        choices: [
            {
                name: "Pardon her",
                outcome: { s: -2, l: -2, m: 3, a: 1 }
            },
            {
                name: "Execute her",
                outcome: { l: 2 }
    ...
    },
    {
        ...
        name: 'Bank Heist',
        weight: 4,
        text: "A string of heists have been happening recently, and the latest is the biggest yet: the Royal Bank of New Anvilhold has just been robbed! Someone needs to catch the theives!",
        choices: [
            {
    ...
    {
        type: 'dilemma',
        name: 'Refugees from Another World',
        ...
        choices: [
            {
                ...
                test: ["DC 12 Medicine", "DC 12 Arcana"],
                success: { l: 1 },
                failure: { s: -3 }
            },
            {
        ...
        choices: [
            {
                ...
                test: ["DC 25 Loyalty (Orcish)"],
                success: { s: 3, a: 1 },
                failure: { l: -5, a: 1 }
            },
            {
                name: "The only good orc is a dead one",
                test: ["DC 18 Military"],
                success: { l: 3, m: -1, r: 1 },
                failure: { l: 3, m: -4 }
            }
    ...
    },
    {
        ...
        weight: 3,
        text: "The Sovereign had a little too much to drink and for some inexplicable reason, publicly supported the Grauhul international siegeball team. Their next match is coming up in a few days and they're playing US! If we win the match, the Sovereign will be humiliated! If we lose, then our own Sovereign will have humiliated his own people! It's a catastrophy!",
        choices: [
            {
...
let crisisDeck = [
        ...
        choices: [
            {
                ...
                success: null,
                failure: { s: -5, unlock: ['rift-1', 'rift-2'] }
            },
        ]
    },
    {
    ...
    },
    {
        ...
        choices: [
            {
                name: "Call for a ceasefire",
                test: ["DC 16 Persuasion (Elvish)", "DC 16 Insight (Elvish)"],
                success: { s: -1, a: 1 },
                failure: { m: -2, s: -2, e: -2 }
            },
            {
                name: "Annex those knife-eared bastards",
                test: ["DC 17 Attack", "DC 13 Intimidation"],
    ...
    },
    {
        ...
        id: "dragon-1",
        weight: 15,
        text: "Aziltraxia, a green dragon that lairs the nearby Mount Skullbane, has attacked one of our cities, flooding the streets with her toxic breath! She demands tribute, threatening the lives of our citizens!",
        choices: [
            {
...
let locked = [
    ...
    },
    {
        ...
        choices: [
            {
                name: "Accept her offer",
                outcome: { e: -8, a: 1, m: 5, i: 3 }
            },
            {
                name: "Bargain with the dragon",
                test: ["DC 20 Persuasion"],
                success: { e: -3, a: 1, m: 5},
                failure: { text: "Aziltraxia will be spurned." }
            }
        ]
    },
    {
        ...
        choices: [
            {
                ...
                test: ["DC 20 Arcana", "DC 20 Acrobatics"],
                success: { s: -2, a: 1 },
                failure: { s: -6 }
            }
        ]
    ...
    },
    {
        ...
        choices: [
            {
                ...
                outcome: { e: -5, m: -5, unlock: ['main-7'] }
            }
        ]
    }, {
        type: 'threat',
        name: "The Menace of Sarkhet Kha'Zul",
        id: "main-6",
        weight: 10,
        text: "Our expedition to the desert has revealed the origins of the reliquary - the final resting place of an ancient, powerful and tyrannical ruler known as Sarkhet Kha'Zul. The curse is clearly tied to this object. We must be prepared to deal with it.",
        choices: [
            {
        ...
        choices: [
            {
                ...
                outcome: { e: -5, m: -5, s: -6, unlock: ['main-8']}
            }
        ]
    }, {
        type: 'threat',
        ...
        choices: [
            {
                name: "There must be hope",
                outcome: { l: -10, unlock: ['main-8'] }
            }
        ]
    }, {
        type: 'threat',
        name: "The Relequary Whispers!",
        id: "main-8",
        weight: 5,
        ...
        choices: [
            {
                ...
                test: ["DC 20 Wisdom", "DC 16 Perception", "DC 16 History"],
                success: { l: -5, p: 3},
                failure: { l: -10, text: "???"}
            }
        ]
